...
const mindfulnessExercises = [
  ...
  },
  {
    ...
    title: "Mindful Pause",
    description:
      "Take a moment to pause, close your eyes, and focus on your sensations.",
    duration: "1 minute",
  },
  {
    id: 3,
    title: "Desk Stretch",
    description: "Stretch your arms, neck, and shoulders to release tension.",
    duration: "3 minutes",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    title: "Eye Rest",
    description:
      "Look away from your screen and focus on an object at least 20 feet away.",
    duration: "30 seconds",
  },
];
    ...
    (set, get) => ({
      ...
      addScreenTime: (category, minutes) => {
        ...
        set((state) => {
          ...
          const categoryIndex = updatedScreenTime.findIndex(
      ...
      getSuggestedExercise: () => {
        const randomIndex = Math.floor(
          Math.random() * mindfulnessExercises.length
        );
      ...
      detectStressFromInteraction: (interactionData) => {
        ...
        set((state) => {
          ...
          const newStressLevel = Math.min(
            100,
            todayData.stressLevel + stressIncrease
          );
      ...
      getOptimizedSchedule: (tasks) => {
        ...
        return sortedTasks.map((task) => {
          ...
          const endTime = new Date(
            startTime.getTime() + task.estimatedTime * 60000
          );

...
import NoteSummarizer from "./NoteSummariser";

const TimeTracker = () => {
  const { dailyData, addScreenTime, userData, currentDay } = useAppStore();
    ...
    <div className="space-y-8">
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Monitor your screen time, track work hours, and maintain a healthy
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">
              {Math.floor(todayData.totalScreenTime / 60)}h{" "}
              {todayData.totalScreenTime % 60}m
            </div>
              ...
              <div className="w-full bg-secondary rounded-full h-2.5">
                <div
                  ...
                  style={{
                    width: `${Math.min(
                      100,
                      (todayData.totalScreenTime / maxWorkTime) * 100
                    )}%`,
                  }}
                ></div>
              </div>
              ...
              <div className="w-full bg-secondary rounded-full h-2.5">
                <div
                  ...
                  style={{
                    width: `${Math.min(
                      100,
                      (todayData.workHours / userData.maxWorkHours) * 100
                    )}%`,
                  }}
                ></div>
              </div>
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 rounded-lg bg-secondary/50">
            ...
            <p className="text-sm text-muted-foreground">
              You spend most of your screen time on productivity applications,
              which is good. However, consider taking more regular breaks to
              reduce overall screen time. Your productivity appears highest
        ...
        <CardContent>
          <ul className="space-y-2 text-sm">
            ...
            <li className="flex items-start gap-2">
              <span className="text-balance-300">•</span>
              <span>
                Take a 5-10 minute break every hour to stand up, stretch, and
                move around.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-balance-300">•</span>
              <span>
                Consider using "Night Light" or blue light filters in the
                evening to reduce eye strain.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-balance-300">•</span>
              <span>
                Aim to finish screen-based work at least 1 hour before bedtime
